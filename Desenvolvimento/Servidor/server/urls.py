...
urlpatterns = [
    ...
    path('recuperarSenha/', views.RecuperaEmail.as_view()),
    path('recuperar/<str:token>/<int:id>', views.RecuperaSenha),
    ...
    path('exibirPev/',coletaViews.ExibirPEV.as_view()),
